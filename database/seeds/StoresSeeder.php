        ...
        foreach ($storesList as $key => $store) {
           ...
           // upload images from storage folder to cloudinary for every restaurant
            ...
            Store::create([
                ...
                'contactText' =>
                "We enjoy talking with those who order food on " . $store .
                " because that's how we find out what we should do better.
                That's why we encourage you to tell us what you like and
                what you don't when you order food from us.",
                ...
                'aboutText' =>
                "What does " . $store . " offer? Possibility to enjoy delicious
                dishes from restaurants in your area. A wide range of delicious
                dishes are at your disposal with just a few clicks."
            ]);
        }
    }
}
